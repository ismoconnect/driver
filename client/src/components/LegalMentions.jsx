      ...
      <main className="max-w-3xl mx-auto px-6 pt-16">
        ...
        <div className="space-y-8 text-slate-400 text-sm sm:text-base leading-relaxed">
          ...
          <section className="bg-slate-900/30 border border-white/5 p-6 sm:p-8 rounded-2xl">
            <h2 className="text-white font-extrabold text-lg mb-4">1. Présentation de la plateforme</h2>
            <p className="mb-3">
          ...
          {/* Section 2 */}
          <section className="bg-slate-900/30 border border-white/5 p-6 sm:p-8 rounded-2xl">
            <h2 className="text-white font-extrabold text-lg mb-4">2. Hébergement</h2>
            <p>
          ...
          {/* Section 3 */}
          <section className="bg-slate-900/30 border border-white/5 p-6 sm:p-8 rounded-2xl">
            <h2 className="text-white font-extrabold text-lg mb-4">3. Propriété intellectuelle</h2>
            <p className="mb-3">
          ...
          {/* Section 4 */}
          <section className="bg-slate-900/30 border border-white/5 p-6 sm:p-8 rounded-2xl">
            <h2 className="text-white font-extrabold text-lg mb-4">4. Limitation de responsabilité</h2>
            <p className="mb-3">

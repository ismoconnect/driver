  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 md:space-y-8 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
        ...
        <div className="flex flex-nowrap gap-1 sm:gap-2 w-full sm:w-auto overflow-x-auto pb-1 sm:pb-0 scrollbar-none">
          {[
            { key: 'all', label: 'Tous' },
            ...
            <button
              ...
              className={`px-2 py-1.5 sm:px-3 sm:py-2 rounded-xl text-[10px] sm:text-xs font-bold transition-all whitespace-nowrap ${
